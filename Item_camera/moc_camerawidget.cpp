...
QT_MOC_LITERAL(4, 35, 13), // "captureFailed"
QT_MOC_LITERAL(5, 49, 8), // "errorMsg"
QT_MOC_LITERAL(6, 58, 12), // "captureImage"
QT_MOC_LITERAL(7, 71, 15), // "onImageCaptured"
QT_MOC_LITERAL(8, 87, 2), // "id"
QT_MOC_LITERAL(9, 90, 7), // "preview"
QT_MOC_LITERAL(10, 98, 13), // "onCameraError"
QT_MOC_LITERAL(11, 112, 14), // "QCamera::Error"
QT_MOC_LITERAL(12, 127, 5) // "error"

    },
    "CameraWidget\0imageSaved\0\0imagePath\0"
    "captureFailed\0errorMsg\0captureImage\0"
    "onImageCaptured\0id\0preview\0onCameraError\0"
...
void CameraWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->imageSaved((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->captureFailed((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::imageSaved)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CameraWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::captureFailed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CameraWidget::imageSaved(const QString & _t1)
{
...
// SIGNAL 1
void CameraWidget::captureFailed(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
